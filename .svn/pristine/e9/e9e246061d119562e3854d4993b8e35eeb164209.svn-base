...
<div class="container">
    <div class="spread brokerage_top">
        <p class="spread_p1">惠享分</p>
        <p class="spread_p2" style="font-size: 35px;">
        	<fmt:formatNumber type="number" value="${totalPrice} " maxFractionDigits="2"/>
        </p>
    </div>
    <div style="text-align: right;background:#EE4F3B;padding-right: 10px;"><a href="myRedPakcet" target="_self">惠享明细</a><i class="iconfont icon-gengduo1 icon-por"></i></div>
    <div class="brokerage_info border-bottom">
        ...
        <div class="brokerage_info_tabl1 brokerage_info_tab2">
          <p>惠享豆</p>
          <span style="font-size: 23px;">${redNum}</span>
        </div>
        <div class="brokerage_info_tabl1 brokerage_info_tab2">
          <p>惠享金额</p>
          <span style="font-size: 23px;">${redPrice}</span>
        </div>
        <div class="brokerage_info_tabl1  brokerage_info_tab2">
          <p>累计消费</p>
          <span style="font-size: 23px;">${totalPay}</span>
        </div>
        <div class="brokerage_info_tabl1">
          <p>累计惠享</p>
          <span style="font-size: 23px;">${givePrice}</span>
        </div>
        <div class="clear"></div>
    </div>
			                    ...
			                    if(data.list.length != null && data.list.length != 'undefined'){
			                        ...
			                        $(data.list).each(function(i,n){
			                            lis += "<div class='next_Shop_info'>"
				                            ...
				                            + "<p>订单金额: <span>"+n.totalPrice+"</span></p>"
				                            + "<p>消费惠享分: <span>"+n.prePayment+"</span></p>"
				                            + "<p>订单时间: <span>"+n.createTime+"</span></p>"
				                            + "</div>";
			                        });
