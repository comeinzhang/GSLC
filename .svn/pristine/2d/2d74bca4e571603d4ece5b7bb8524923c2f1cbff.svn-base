...
<div class="container">
	<div class="registered">
		<form action="saveAddr" name="addrForm" id="addrForm" method="post">
   		<p>姓　　名 : <input type="text" name="name"  value="" placeholder="请输你的名字" maxlength="10"></p>
    	<p>手　　机 : <input type="text" name="phone" value="" placeholder="如13882113500" maxlength="11"></p>
        <p>所在地区 : <input type="text" readonly="readonly" name="s_city" id="s_city" value=""></p>   		
        <p>详细地址 : <input type="text" name="addrdetail" id="addrdetail" value=""></p>
    ...
    <div class="address_szmr">
    	...
    	<p class="registered_zc address_gl" onclick="saveAddr();">保存并使用</p>
    </div>
</div>
<script>
