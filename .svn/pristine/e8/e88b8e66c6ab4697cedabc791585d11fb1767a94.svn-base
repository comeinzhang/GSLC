...
<div class="p-heat">
    ...
    <div class="login-index">
        <div class="ip-list">
            ...
            <div class="row">
                <p class="p2"><input type="password" name="newPwd" placeholder="请输入新二级密码, 至少6位"></p>
            </div>
            <div class="row">
                <p class="p2"><input type="password" name="newPwd1" placeholder="请再次输入新二级密码"></p>
            </div>
