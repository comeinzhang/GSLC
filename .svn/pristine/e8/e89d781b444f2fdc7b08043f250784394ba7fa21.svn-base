...
<div class="goods-info">
    ...
    <div class="goods-msg bgfff">
        ...
        <p class="price"><span>&yen;</span>${specList[0].price }<span style="font-size: 15px;color: black;">(${specList[0].price*goods.comsGoods }ev)</span>
       <c:if test="${goods.id eq 201}"> <span style="float: right;padding-right: 10px;" onclick="replySymptom();">产品体验</span></c:if>
        </p>
        ...
        <div class="select-box">
            ...
            <div class="item">
                ...
                <div class="text">
                    ...
                    <p class="price" style="padding-right: 25px;">&yen;<span id="goodsPrice">${specList[0].price }</span></p>
            ...
            <div class="select-list clearfix">
                ...
                <div class="right">
                    <c:if test="${goods.id==199}">
                    	...
                    	<p onclick="location.href='${pageContext.request.contextPath}/goods/getGoodsById?id=200'">修护合伙</p>
                    	<p onclick="location.href='${pageContext.request.contextPath}/goods/getGoodsById?id=201'">体验合伙</p>
                    </c:if>
                    <c:if test="${goods.id==200}">
                    	<p onclick="location.href='${pageContext.request.contextPath}/goods/getGoodsById?id=199'">羞修合伙</p>
            		     <c:forEach items="${specList }" var="spec" varStatus="status">
	                    	<p id="${spec.id }" <c:if test="${status.index eq 0}">class="active"</c:if>>${spec.specValue }</p>
	                    </c:forEach>
                    	<p onclick="location.href='${pageContext.request.contextPath}/goods/getGoodsById?id=201'">体验合伙</p>
                    </c:if>
                    <c:if test="${goods.id==201}">
                    	<p onclick="location.href='${pageContext.request.contextPath}/goods/getGoodsById?id=199'">羞修合伙</p>
                    	<p onclick="location.href='${pageContext.request.contextPath}/goods/getGoodsById?id=200'">修护合伙</p>
                   		<c:forEach items="${specList }" var="spec" varStatus="status">
	                    	<p id="${spec.id }" <c:if test="${status.index eq 0}">class="active"</c:if>>${spec.specValue }</p>
...
<!--                 </ul> -->
    ...
    <div class="bottom">
        <div class="gys">
            ...
            <a href="tel:4000167117"><label>联系客服</label></a>
        </div>
...
<div id="gallery" class="pswp" tabindex="-1" role="dialog" aria-hidden="true">
   ...
   function replySymptom(){
			location.href="../user/toReplySymptom";
   }
   function goBack(){
    ...
    $(document).ready(function(){
        ...
        function collectionOperation(){
            ...
            var user = '${sessionScope.user}';
                	...
                	var data={goods_id:goods_id,flag:"0"};
					$.ajax({
		                cache: true,
		                type: "POST",
		                url:url,
