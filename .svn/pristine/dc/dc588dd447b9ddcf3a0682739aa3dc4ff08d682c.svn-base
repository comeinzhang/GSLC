...
<div class="page-warp">
    ...
    <div class="fax-index">
        ...
        <div class="xd-b">
            <div class="t">
                <p class="p1"><img src="../static/images/221_03.jpg"></p>
                <span class="s1">
                    <a href="moreShop">更多<i class="iconfont icon-gengduo"></i></a>
                </span>
            </div>
            <div class="g-list">
...
<%--        <div class="fj-b">--%>
<%--            <div class="ppt">--%>
<%--                <img src="images/tt_03.png"> 附近店铺 <img src="../static/images/tt_03.png">--%>
<%--            </div>--%>
<%--            <div class="g-list">--%>
<%--                <div class="goods-box">--%>
<%--                    <div class="content">--%>
<%--                        <div class="pic"><img src="images/0337.png"></div>--%>
<%--                        <div class="text">--%>
<%--                            <div class="ll">12浏览</div>--%>
<%--                            <div class="name ellipsis">贵州茅台</div>--%>
<%--                            <div class="xx">--%>
...
<%--                                星--%>
<%--                            </div>--%>
<%--                            <div class="xx">主营：酒，水果罐头，新鲜水果等</div>--%>
<%--                            <div class="jl">距您:12Km</div>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
<%--                <div class="goods-box">--%>
            ...
            callback : function(i){
			    ...
			    function getGoods(){
			        if(!isLastPage && !goodsGetIn){
			        	...
			        	//var data={pages:pages,name:name,addr:addr,pageSize:4,shopType:3};
			        	var data={pages:pages,name:name,addr:addr,pageSize:4};
			            $.ajax({
			            	cache: true,
			                type: "POST",
			                url:"shopList",
