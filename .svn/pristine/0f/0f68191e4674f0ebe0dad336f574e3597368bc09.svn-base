$(function() {  
    ...
    var preProvince = "<option value=\"\">请选择</option>";
    var preCity = "<option value=\"\">请选择</option>";  
    var preArea = "<option value=\"\">请选择</option>"; 
    ...
    $.ajax({  
        type : "GET",  
        url:"../static/js/province_city_select_Info.xml",
